...
bool image_init_module(void);

/* Cleanup the "image" module. */
void image_cleanup_module(void);
...
/* Draw an image on an image. (50% dim-blending) */
void image_draw_dim(struct image *dst_image,
		    int dst_left,
		    int dst_top,
