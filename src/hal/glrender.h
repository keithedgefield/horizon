...
/*
 * glrender.h: The OpenGL implementation for "render" module interface.
 */

#ifndef HORIZON_HAL_GLRENDER_H
#define HORIZON_HAL_GLRENDER_H

#include "config.h"

bool glrender_init_module(int x, int y, int w, int h);
void glrender_cleanup_module(void);
void glrender_resize_screen(int x, int y, int w, int h);
