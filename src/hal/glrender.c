 ...
 */
bool glrender_init_module(int x, int y, int w, int h)
{
	glrender_cleanup_module();
 ...
 */
void glrender_cleanup_module(void)
{
	int i;
 ...
 */
bool render_create_constant_buffer(int size, struct render_constant_buffer **buf)
{
	return false;
}
 ...
 */
void render_destroy_constant_buffer(struct render_constant_buffer *buf)
{
}
...
/*
 * Upload data to a constant buffer.
 */
void render_upload_constant_buffer(struct render_constant_buffer *buf, const float *src)
{
}
